...
#define RANDOMIZER_FLAG_WILD_MON                      FLAG_RANDOM_WILD_ENCOUNTERS
#endif
...
#define RANDOMIZER_FLAG_TRAINER_MON                   FLAG_RANDOM_TRAINER_MONS
#endif

#ifndef FORCE_RANDOMIZE_FIXED_MON
#define RANDOMIZER_FLAG_FIXED_MON                     FLAG_RANDOM_FIXED_MONS
#endif

#ifndef FORCE_RANDOMIZE_STARTER_AND_GIFT_MON
#define RANDOMIZER_FLAG_STARTER_AND_GIFT_MON          FLAG_RANDOM_STARTERS_AND_GIFTS
#endif

#ifndef FORCE_RANDOMIZE_EGG_MON
#define RANDOMIZER_FLAG_EGG_MON                       FLAG_RANDOM_EGGS
#endif

#ifndef FORCE_RANDOMIZE_ABILITIES
#define RANDOMIZER_FLAG_ABILITIES                     FLAG_RANDOM_ABILITIES
#endif

#define RANDOMIZER_VAR_SPECIES_MODE                   VAR_RANDOM_SPECIES_MODE

#if RANDOMIZER_SEED_IS_TRAINER_ID == FALSE
#define RANDOMIZER_VAR_SEED_L                         VAR_SEED_L
#define RANDOMIZER_VAR_SEED_H                         VAR_SEED_R
#endif

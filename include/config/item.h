...
#define I_KEY_ESCAPE_ROPE               GEN_5  // In Gen8, Escape Rope became a Key Item. Keep in mind, this will make it free to buy in marts.
...
#define I_BERRY_EV_JUMP                 GEN_4       // In Gen4 only, EV-lowering Berries lower a stat's EV to 100 if it is above 100.
...
#define I_ROTOM_CATALOG_THUNDER_SHOCK   GEN_8  // In Gen9+, reverting Rotom to its base form will teach it Thunder Shock even if it knows another move.
...
#define I_EXP_SHARE_FLAG        FLAG_KALOS_EXP_SHARE           // If this flag is set, every Pokémon in the party will gain experience, regardless if they participated in the battle or not.
...
#define VAR_LAST_REPEL_LURE_USED    VAR_REPEL       // If this var has been assigned, last Repel/Lure used will be saved and the player will get prompted with the vanilla repel YES/NO option, unless I_REPEL_LURE_MENU is set to TRUE.
...
// Vs. Seeker
#define I_VS_SEEKER_CHARGING        FLAG_VS_SEEKER  // If this flag is assigned, the Vs Seeker functionality will be enabled. When the player has the Vs. Seeker, Match Call rematch functions will stop working.

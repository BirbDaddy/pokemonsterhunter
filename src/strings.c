...
const u8 gText_Pokemon[] = _("MONSTERS");
...
const u8 gText_ThisIsAPokemon[] = _("This is what we call a “Monster.”{PAUSE 96}\p");
...
const u8 gText_PokedexRegistration[] = _("Monster notes written.");
...
const u8 gText_NoMatchingPkmnWereFound[] = _("No matching monsters were found.");
const u8 gText_SearchForPkmnBasedOnParameters[] = _("Search for monsters based on\nselected parameters.");
const u8 gText_SwitchPokedexListings[] = _("Switch monster note listings.");
const u8 gText_ReturnToPokedex[] = _("Return to the monster notes.");
const u8 gText_SelectPokedexMode[] = _("Select the note bundle.");
const u8 gText_SelectPokedexListingMode[] = _("Select the note listing mode.");
...
const u8 gText_DexSortNumericalDescription[] = _("Monsters are listed according to their\nnumber.");
const u8 gText_DexSortAtoZDescription[] = _("Spotted and owned monsters are listed\nalphabetically.");
const u8 gText_DexSortHeaviestDescription[] = _("Owned monsters are listed from the\nheaviest to the lightest.");
const u8 gText_DexSortLightestDescription[] = _("Owned monsters are listed from the\nlightest to the heaviest.");
const u8 gText_DexSortTallestDescription[] = _("Owned monsters are listed from the\ntallest to the smallest.");
const u8 gText_DexSortSmallestDescription[] = _("Owned monsters are listed from the\nsmallest to the tallest.");
...
const u8 gText_HOFDexRating[] = _("Spotted monsters:0 {STR_VAR_1}!\nOwned monsters: {STR_VAR_2}!\pPROF. BIRCH's POKéDEX rating!\pPROF. BIRCH: Let's see…\p");
...
const u8 gText_BirchInTrouble[] = _("PROF. BIRCH is in trouble!\nRelease a monsters and rescue him!");
const u8 gText_ConfirmStarterChoice[] = _("Do you choose this monster?");
const u8 gText_Pokemon4[] = _("MONSTER"); // Unused
...
const u8 gText_ThePokemonList[] = _("the MONSTER LIST");
...
const u8 gText_ICanPayVar1[] = _("I can pay {STR_VAR_1}z.\nWould that be okay?");
const u8 gText_TurnedOverVar1ForVar2[] = _("Turned over the {STR_VAR_2}\nand received {STR_VAR_1}z.");
const u8 gText_PokedollarVar1[] = _("{STR_VAR_1}z");
...
const u8 gText_NoMoreThanVar1Pkmn[] = _("No more than {STR_VAR_1} MONSTERS\nmay enter.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TeachWhichPokemon2[] = _("Teach which MONSTER?"); // Unused
const u8 gText_ChoosePokemon[] = _("Choose a MONSTER.");
const u8 gText_MoveToWhere[] = _("Move to where?");
const u8 gText_TeachWhichPokemon[] = _("Teach which MONSTER?");
const u8 gText_UseOnWhichPokemon[] = _("Use on which MONSTER?");
const u8 gText_GiveToWhichPokemon[] = _("Give to which MONSTER?");
...
const u8 gText_NoPokemonForBattle[] = _("No MONSTERS for battle!");
const u8 gText_ChoosePokemon2[] = _("Choose a MONSTER.");
const u8 gText_NotEnoughHp[] = _("Not enough HP…");
const u8 gText_PokemonAreNeeded[] = _("{STR_VAR_1} MONSTERS are needed.");
const u8 gText_PokemonCantBeSame[] = _("MONSTERS can't be the same.");
...
const u8 gText_ChoosePokemonCancel[] = _("Choose MONSTER or CANCEL.");
const u8 gText_ChoosePokemonConfirm[] = _("Choose MONSTER and confirm.");
const u8 gText_SendWhichMonToPC[] = _("Send which MONSTER to the PC?");
...
const u8 gText_PkmnCantParticipate[] = _("That MONSTER can't participate.{PAUSE_UNTIL_PRESS}");
...
ALIGNED(4) const u8 gText_PkmnCantBeTradedNow[] = _("That MONSTER can't be traded\nnow.");
ALIGNED(4) const u8 gText_PkmnCantBeTraded[] = _("That MONSTER can't be traded.");
ALIGNED(4) const u8 gText_EggCantBeTradedNow[] = _("An EGG can't be traded now.");
ALIGNED(4) const u8 gText_OtherTrainersPkmnCantBeTraded[] = _("The other TRAINER's MONSTER\ncan't be traded now.");
...
ALIGNED(4) const u8 gText_NotPkmnOtherTrainerWants[] = _("That isn't the type of MONSTER\nthat the other TRAINER wants.");
...
const u8 gText_RentalPkmn[] = _("RENTAL MONSTER");
...
const u8 gText_PkmnInfo[] = _("MONSTER INFO");
const u8 gText_PkmnSkills[] = _("MONSTER SKILLS");
...
const u8 gText_OddEggFoundByCouple[] = _("An odd MONSTER EGG found\nby the DAY CARE couple.");
const u8 gText_PeculiarEggNicePlace[] = _("A peculiar MONSTER EGG\nobtained at the nice place.");
const u8 gText_PeculiarEggTrade[] = _("A peculiar MONSTER EGG\nobtained in a trade.");
const u8 gText_EggFromHotSprings[] = _("A MONSTER EGG obtained\nat the hot springs.");
const u8 gText_EggFromTraveler[] = _("An odd MONSTER EGG\nobtained from a traveler.");
...
const u8 gText_MenuOptionPokedex[] = _("NOTES");
const u8 gText_MenuOptionPokemon[] = _("MONSTERS");
...
const u8 gText_PokemonNature[] = _("MONSTER NATURE");
const u8 gText_PokemonMoves[] = _("MONSTER MOVES");
const u8 gText_Underpowered[] = _("UNDERPOWERED");
const u8 gText_WhenInDanger[] = _("WHEN IN DANGER");
const u8 gText_BattlePokemon[] = _("BATTLE MONSTERS");
...
const u8 gText_StopGivingPkmnMail[] = _("Stop giving the MONSTER MAIL?");
...
const u8 gText_StopGivingPkmnMail2[] = _("Stop giving the MONSTER MAIL?"); // Unused
...
const u8 gText_PokemonLeague[] = _("MONSTER LEAGUE");
const u8 gText_PokemonCenter[] = _("MONSTER CENTER");
...
const u8 gText_TrainerCardPokedex[] = _("NOTES");
...
const u8 gText_PokemonTrades[] = _("MONSTER TRADES");
...
const u8 gText_Pokemon2[] = _("MONSTERS");
...
const u8 gText_PlayerScurriedToCenter[] = _("{PLAYER} scurried to a MONSTER CENTER,\nprotecting the exhausted and fainted\nMONSTERS from further harm…\p");
const u8 gText_PlayerScurriedBackHome[] = _("{PLAYER} scurried back home, protecting\nthe exhausted and fainted MONSTERS from\nfurther harm…\p");
...
const u8 gText_BattlePalaceDesc[] = _("Watch your MONSTERS battle!\nYour spirit will be tested.");
const u8 gText_BattleArenaDesc[] = _("Win battles with teamed-up MONSTERS!\nYour guts will be tested.");
const u8 gText_BattleFactoryDesc[] = _("Aim for victory using rental MONSTERS!\nYour knowledge will be tested.");
...
const u8 gText_ContinueMenuPokedex[] = _("NOTES");
...
const u8 gText_PkmnJumpRecords[] = _("MONSTER JUMP RECORDS");
...
const u8 gText_MenuPokedex[] = _("NOTES");
const u8 gText_MenuPokemon[] = _("MONSTERS");
const u8 gText_MenuBag[] = _("POUCH");
...
const u8 gText_PokemonOnHook[] = _("A MONSTER's on the hook!{PAUSE_UNTIL_PRESS}");
...
const u8 gEasyChatGroupName_Pokemon[] = _("MONSTERS");
...
const u8 gEasyChatGroupName_Pokemon2[] = _("MONSTERS2");
...
const u8 gText_RentalPkmn2[] = _("RENTAL MONSTERS");
const u8 gText_SelectFirstPkmn[] = _("Select the first MONSTER.");
const u8 gText_SelectSecondPkmn[] = _("Select the second MONSTER.");
const u8 gText_SelectThirdPkmn[] = _("Select the third MONSTER.");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three MONSTERS OK?");
const u8 gText_Yes2[] = _("YES");
const u8 gText_No2[] = _("NO");
const u8 gText_CantSelectSamePkmn[] = _("Can't select same {PKMN}.");
const u8 gText_PkmnSwap[] = _("MONSTER SWAP");
const u8 gText_SelectPkmnToSwap[] = _("Select MONSTER to swap.");
const u8 gText_SelectPkmnToAccept[] = _("Select MONSTER to accept.");
...
const u8 gText_AcceptThisPkmn[] = _("Accept this MONSTER?");
...
const u8 gText_SavingPokedex[] = _("NOTES");

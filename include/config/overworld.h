...
#define OW_FLAG_NO_ENCOUNTER        FLAG_DISABLE_WILD_ENCOUNTERS  // If this flag is set, wild encounters will be disabled.
...
#define OW_FLAG_NO_COLLISION        FLAG_NO_COLLISSION  // If this flag is set, the player will be able to walk over tiles with collision. Mainly intended for debugging purposes.

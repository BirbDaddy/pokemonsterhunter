...
const u8 *const gBattleStringsTable[BATTLESTRINGS_COUNT] =
{
    ...
    [STRINGID_PLAYERGOTMONEY]                       = COMPOUND_STRING("You got {B_BUFF1}z for winning!\p"),
    [STRINGID_PLAYERWHITEOUT]                       = COMPOUND_STRING("You have no more Pokémon that can fight!\p"),
#if B_WHITEOUT_MONEY >= GEN_4
    [STRINGID_PLAYERWHITEOUT2]                      = COMPOUND_STRING("You panicked and dropped {B_BUFF1}z…\pYou were overwhelmed by your defeat!{PAUSE_UNTIL_PRESS}"),
#else
    ...
    [STRINGID_PLAYERPICKEDUPMONEY]                  = COMPOUND_STRING("You picked up {B_BUFF1}z!\p"),
    ...
    [STRINGID_PLAYERPAIDPRIZEMONEY]                 = COMPOUND_STRING("You gave {B_BUFF1}z to the winner…\pYou were overwhelmed by your defeat!{PAUSE_UNTIL_PRESS}"),
...
const u8 gText_BattleMenu[] = _("Battle{CLEAR_TO 56}Pouch\nMonsters{CLEAR_TO 56}Run");
